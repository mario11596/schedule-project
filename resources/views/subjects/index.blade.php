    ...
    <div class="py-2">
        ...
        <div class="flex justify-between my-2">
                <div class="flex">
                  ...
                  <a href="{{ route('subjects.create') }}" class="btn btn-outline-primary"> 
              ...
              <table class="items-center bg-transparent w-full table table-bordered ">
                <thead>
                  ...
                  <th class="px-6 bg-blueGray-50 text-blueGray-500 align-middle border border-solid border-blueGray-100 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-center">Br.</th>
                    ...
                    <th class="px-6 bg-blueGray-50 text-blueGray-500 align-middle border border-solid border-blueGray-100 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-center">Preostali broj sati</th>
                ...
                <tbody>
                  ...
                  <tr>
                    <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-center">{{ ++$index }}</td>
                    <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-center">{{ $subject->name }}</td>

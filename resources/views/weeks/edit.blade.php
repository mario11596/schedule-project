                ...
                <form action="{{ route('weeks.update', $week->id) }}" method="POST">
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <option value="smjer1" {{($week->course == 'smjer1') ? 'selected' : ''}}>Smjer1</option>
                            <option value="smjer2" {{($week->course == 'smjer2') ? 'selected' : ''}}>Smjer2</option> 
                            </select>
                        </div>
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <option value="ljetniSemestar" {{($week->semester == 'ljetniSemestar') ? 'selected' : ''}}>Ljetni semestar</option>
                            <option value="zimskiSemestar" {{($week->semester == 'zimskiSemestar') ? 'selected' : ''}}>Zimski semestar</option>
                            </select>
                        </div>
